...
get.oc <- function(targetT,targetE, ndose,ncohort, cohortsize, startdose=1, stop=150, cutoff.eliT=0.95, cutoff.eliE=0.95, ntrial=100,utilitytype = 1, randomtype = 1)
{
...
simprob<-function(ndose,targetE,targetT,u1,u2 ,randomtype){
  ...
  effint_l<-c(0,0.2,0.4,0.6)
  effint_u<-c(0.2,0.4,0.6,1)
  toxint_l<-c(0,0.15,0.3,0.35)
  toxint_u<-c(0.15,0.3,0.35,1)
  JUPM<-rep(0,16)
  set.seed(30);
  ################## simulate trials ###################
...
oc = get.oc(targetT=0.3,targetE=0.2, ndose=5,ncohort=i, cohortsize=3, startdose=1, stop=150, cutoff.eliT=0.95, cutoff.eliE=0.9, ntrial=10000,utilitytype = utype, randomtype = rtype)
