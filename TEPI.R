...
## ----------------------------------------------------------------------------
## Description: Function to generate operating characteristics of TEPI 
## ----------------------------------------------------------------------------
## Required Packages:  Iso, data.table
## ----------------------------------------------------------------------------
## Usage: get.oc<-function(targetT=0.3,targetE=0.2,ncohort=10,cohortsize=3, startdose=1,
...
get.oc <- function(targetT,targetE, ndose,ncohort, cohortsize, startdose=1, cutoff.eliT=0.95, cutoff.eliE=0.95, ntrial=100,utilitytype = 1, randomtype = 1)
{
  ...
  for(trial in 1:ntrial)
  {
   ...
   kk = probs$pT
    ...
    {  			
      ...
      if(n[d]>=3 && pbeta(targetE,yE[d]+1,n[d]-yE[d]+1)>cutoff.eliE) {
        elimi[d]=1;
...
oc = get.oc(targetT=TARGET.T,targetE=TARGET.E, ndose=NDOSE,ncohort=i, cohortsize=3, startdose=STARTD,  cutoff.eliT=0.95, cutoff.eliE=0.9, ntrial=10000,utilitytype = utype, randomtype = rtype)
...
write.csv(outputmat,paste0(iii,"/tepi_random.csv"),row.names=FALSE)
