...
## ----------------------------------------------------------------------------
## Description: Function to generate operating characteristics of BOINET 
## ----------------------------------------------------------------------------
## Required Packages:  Iso, data.table
## ----------------------------------------------------------------------------
## Usage: get.oc <- function(targetT=0.3, targetE=0.25,ndose,ncohort, cohortsize, startdose=1,  cutoff.eliT=0.95, cutoff.eliE=0.95, ntrial=100,utilitytype = 1, randomtype = 1)
##
...
get.oc <- function(targetT=0.3, targetE=0.25,ndose,ncohort, cohortsize, startdose=1,  cutoff.eliT=0.95, cutoff.eliE=0.95, ntrial=100,utilitytype = 1, randomtype = 1)
{
