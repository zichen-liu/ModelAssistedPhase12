...
oc = get.oc(targetT=0.3,targetE=0.2, ndose=5,ncohort=i, cohortsize=3, startdose=3, stop=150, cutoff.eliT=0.95, cutoff.eliE=0.9, ntrial=10000,utilitytype = utype, randomtype = rtype)
