...
## ----------------------------------------------------------------------------
## Description: Function to generate operating characteristics of uTPI 
## ----------------------------------------------------------------------------
...
get.oc <- function(targetE,targetT, ndose,ncohort, cohortsize, startdose=1, cutoff.eliT=0.95, cutoff.eliE=0.90, ntrial=10, utilitytype = 1, randomtype = 1)
{
...
oc = get.oc(targetE=TARGET.E,targetT=TARGET.T, ndose=NDOSE, ncohort=i, cohortsize=3, startdose=STARTD, cutoff.eliT=0.95,
            cutoff.eliE=0.9, ntrial=10000, utilitytype = utype, randomtype = rtype)
