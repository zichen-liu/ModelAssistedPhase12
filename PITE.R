...
## ----------------------------------------------------------------------------
## Description: Function to generate operating characteristics of PRINTE
## ----------------------------------------------------------------------------
## Required Packages:  Iso, data.table
## ----------------------------------------------------------------------------
## Usage: PITE_sim <- function(pT, pE, zetaE, psafe=0.95, pfutility=0.95, eps1=0.05, eps2=0.05, startdose=1, cohortsize=3,ncohort=10, nsimul=1000,utilitytype = 1, randomtype = 1)
##
##      pT: target toxicity probability, i.e., the \phi_T in the manuscript.
##      pE: the target  efficacy probability, i.e., the \phi_E in the manuscript.
##      zetaE: lower limit for the efficacy rate, i.e., the \zeta_E in the manuscript.
...
##      psafe: the posterior probability cutoff for toxicity dose elimination rule.
##      pfutility: the posterior probability cutoff for futility dose elimination rule.
...
PITE_sim <- function(pT, pE, zetaE, psafe=0.95, pfutility=0.95, eps1=0.05, eps2=0.05, startdose=1, cohortsize=3,ncohort=10, nsimul=1000,utilitytype = 1, randomtype = 1){
...
oc = PITE_sim(pT=TARGET.T, pE=0.4, zetaE = TARGET.E, psafe=0.95, pfutility=0.9, eps1=0.05, eps2=0.05,  startdose=STARTD, cohortsize=3,ncohort=i, nsimul=10000,utilitytype = utype, randomtype = rtype)
