...
tbl = fread(paste0(PATH,'/intermediate/NDOSE5_START2/simres', ub.setting, '.csv'))
...
p1=as.data.table(p1)
preferred.order = c("uTPI","BOIN-ET","Joint3+3","STEIN","PRINTE", "TEPI","BOIN12", "M-BOIN12", "EffTox")
...
fwrite((rbind(p2,p1)),paste0("results/", ub.setting, "/Table3.csv"))