...
## ----------------------------------------------------------------------------
## Description: Function to generate operating characteristics of Joint i3+3 
## ----------------------------------------------------------------------------
## Required Packages:  Iso, data.table
## ----------------------------------------------------------------------------
## Usage: ji3plus3_sim <- function(pT=0.3,  pE=0.4, zetaE = 0.2, eps1=0.05, eps2=0.05, 
...
ji3plus3_sim <- function(pT=0.3,  pE=0.4, zetaE = 0.2, eps1=0.05, eps2=0.05, 
                         psafe=0.95, pfutility=0.95, 
                         cohortsize=3,ncohort=10,startdose=1,
                         nsimul=1000,utilitytype = 1, randomtype = 1){
  ...
  for (simul in 1:nsimul){ 
    ...
    while(st == 0){
      ...
      if (pbeta(zetaE, parabeta[1] + y[d], parabeta[2] + n[d] - y[d]) > pfutility) {
        dfut[d] <- 2
      }
...
oc =ji3plus3_sim(pT=TARGET.T,  pE=0.4, zetaE = TARGET.E, eps1=0.05, eps2=0.05, 
                         psafe=0.95, pfutility=0.9, 
                         cohortsize=3,ncohort=i,startdose=STARTD,
