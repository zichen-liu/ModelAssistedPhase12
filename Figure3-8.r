...
utpi= temp("\\utpi_random.csv")
boin=temp("\\BOINET_random.csv")
efft=temp("\\efftox_random.csv")
tepi=temp("\\tepi_random.csv")
boin12 = temp("\\boin12_random.csv")
ji3 = temp("\\ji3_random.csv")
printe = temp("\\printe_random.csv")
stein = temp("\\stein_random.csv")
...
setEPS()
postscript(paste0("bdsel",RTYPE,UTYPE,".eps"))
...
## Figure 4
setEPS()
postscript(paste0("odsel",RTYPE,UTYPE,".eps"))
...
## Figure 5
setEPS()
postscript(paste0("bdpts",RTYPE,UTYPE,".eps"))
...
## Figure 6
setEPS()
postscript(paste0("poor",RTYPE,UTYPE,".eps"))
...
## Figure 7
setEPS()
postscript(paste0("overdose",RTYPE,UTYPE,".eps"))
...
## Figure 8
setEPS()
postscript(paste0("ovsel",RTYPE,UTYPE,".eps"))
